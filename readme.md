...
R with popular packages for text mining in Docker.
...
- RJDBC jsonlite
- data.table plyr dplyr tidytext tidyverse
...
```
docker pull dclong/r-pop:text_mining
```
...
```
docker pull registry.docker-cn.com/dclong/r-pop:text_mining
```
